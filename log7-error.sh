...
#grep -e "tekitou" tm1server.log.org.start | replace_timestamp >> tm1server.log.tmp

# Modify filename for TM1ProcessError file
# $1 is job name argument
modified_filename=$(modify_filename "TM1ProcessError_20231130140136_41513540_$1.log")
